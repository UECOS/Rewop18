...
void CheckTemperatureStatus()
{
  try
  {
    ...
    if(abs(base_temp - temperature) > 5 && curOpened && !temperatureAlert){
      Screen.print(2, "Tuere zu!(T)");
    ...
    if(abs(base_humidity - humidity) < 5 && highHumidityAlert){
      Screen.print(2, "Tuere zu!");
      highHumidityAlert = false;
    }

    if(humidity > 60 && !curOpened && !highHumidityAlert){
      Screen.print(2, "Tuere oeffnen!");
      highHumidityAlert = true;
    }

    if(highHumidityAlert) {
      Screen.print(3, "Hohe Feuchtigkeit!");
    } else if(temperatureAlert) {
      Screen.print(3, "Temperatur!");
    } else {
      Screen.print(2, "                   ");
      Screen.print(3, "                   ");
    }
